	...
	__reloader.Reloader = Reloader = (function() {
		...
		Reloader.prototype.reloadStylesheet = function(path) {
			...
			if (match) {
				...
				this.console.log("LiveReload did not match any '" + path + "' stylesheet");
		...
		Reloader.prototype.waitUntilCssLoads = function(clone, func) {
			...
			if (!this.knownToSupportCssOnLoad) {
				(poll = function() {
					if (clone.sheet) {
						this.console.log("polling", clone.href);
						return executeCallback();
					} else {
...
__livereload.LiveReload = LiveReload = (function() {
	...
	function LiveReload(window) {
		...
		this.console = this.window.location.search.match(/LR-verbose/) && this.window.console && this.window.console.log && this.window.console.error ? this.window.console : {
			log: function() {},
			error: function() {}
		};
